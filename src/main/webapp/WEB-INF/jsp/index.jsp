...
<html>
	<head>
    	...
    	<script src= "/findcompanydetails.js"></script>
	</head>

	<body>
		<button type="button" onclick="addData('/addcompany')">Add Company</button> <br><br>

		<button type="button" onclick="addData('/updatecompany')">Update Company</button>
